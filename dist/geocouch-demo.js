...
L.Draggable = L.Class.extend({
	...
	_matchTarget: function (e) {
		...
		// then also stop
		while (targ && (targ !== this._dragStartTarget)) {
			targ = targ.parentNode;
		} // while

		return targ && (targ === this._dragStartTarget);
	},

	_onDown: function (e) {
		if ((!L.Browser.touch && e.shiftKey) || ((e.which !== 1) && (e.button !== 1) && !e.touches && !this._matchTarget(e))) {
			return;
		}
